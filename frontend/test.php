...
<?php 	if(!isset($_GET['part']) && !isset($_GET['certificate']) && isset($_COOKIE['current_group'])){ 
			wp_redirect("?part=".$GLOBALS['tests']->get_part(get_the_ID())."&group=".$_COOKIE['current_group']); 
		} 
?>
